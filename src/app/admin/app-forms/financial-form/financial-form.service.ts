...
export class FinancialFormService {
    readonly endPoint = 'FinancialForm'
    dbCollection: AngularFirestoreCollection<FinancialFormModel>;
    ...
    constructor(
        ...
        this.dbCollection = this.db.collection<FinancialFormModel>(this.endPoint);
    }

    create(data: FinancialFormModel) {
        data._updatedAt = (new Date()).toISOString();
        data._createdAt = (new Date()).toISOString();
        return this.dbCollection.add(data);
    }

    update(values: FinancialFormModel) {
    ...
    get(data?: QueryParam[]) {
        return this.db.collection<FinancialFormModel>(this.endPoint, (ref: any) => {
            data.forEach(e => {
